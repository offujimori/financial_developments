...
while True:
    try:
        ...
        if Trade == True:
            ...
            if Signal == "BUY":
                try:
                    Order_MKT(Units_Size, Trend_Buy_ID_Order, Trend_Buy_ID)
                except Exception as Error:
                    print(Error)
                    print("<... BUY TREND ALREADY IN ...>")
                try:
                    Order_MKT(-Units_Size, Range_Sell_ID_Order, Range_Sell_ID)
                except Exception as Error:
                    print(Error)
                ...
                try:
                    Order_MKT(-Units_Size, Trend_Sell_ID_Order, Trend_Sell_ID)
                except Exception as Error:
                    print(Error)
                    print("<... SELL TREND ALREADY IN ..>")
                try:
                    Order_MKT(Units_Size, Range_Buy_ID_Order, Range_Buy_ID)
                except Exception as Error:
                    print(Error)
