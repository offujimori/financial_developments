...
print("*** LUZO ***")
print("--- AVISO: Esse estilo operacional exige tempo e está sujeito a drawdown inicial de acordo com o temperamento regente do mercado ---\n"
      "Estilo: Posições vencedoras fecham. Perdedoras se mantem. Saídas: após movimento de tendência. Saída na retração.")
