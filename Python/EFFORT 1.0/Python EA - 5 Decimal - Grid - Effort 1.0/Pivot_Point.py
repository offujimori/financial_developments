...
PP = round(((previousHigh + previousLow + previousClose) / 3), 5)
S1 = round((2*PP) - previousHigh, 5)
S2 = round(PP - (previousHigh - previousLow), 5)
S3 = round(previousLow - 2*(previousHigh - PP), 5)
R1 = round((2*PP) - previousLow, 5)
R2 = round(PP + (previousHigh - previousLow), 5)
R3 = round(previousHigh + 2*(PP - previousLow), 5)
##
