...
##SET GRID SCALE##
Grid_scale = 5
Grid_distance = round((Grid_max - Grid_min), 5)
Grid_sizebox = round((Grid_distance/Grid_scale),5)
##
...
##GRID PRICES##
Grid_0 = Grid_min
Grid_1 = round(Grid_min + (1*Grid_sizebox),5)
Grid_2_channel_low = round(Grid_min + (2*Grid_sizebox) ,5)
Grid_3_channel_high = round(Grid_min + (3*Grid_sizebox), 5)
Grid_4 = round(Grid_min + (4*Grid_sizebox), 5)
Grid_5 = Grid_max
##
