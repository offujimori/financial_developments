...
try:
    ...
    def Instrument_CANDLES_Current():
        params = {"price": "M", "count": 2, "granularity": Granularity, "weeklyAlignment": "Sunday",
                  "dailyAlignment": "17"}
    ...
    def Instrument_CANDLES_Pre_Previous():
        params = {"price": "M", "count": 3, "granularity": Granularity, "weeklyAlignment": "Sunday",
                  "dailyAlignment": "17"}
        r = instruments.InstrumentsCandles(instrument=Instrument, params=params)
        rv = Client.request(r)
        result = rv["candles"]
