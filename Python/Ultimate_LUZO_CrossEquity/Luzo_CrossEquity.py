...
Account_Live_TOKEN = "9e9f8572bb706a0eeb30f8b0d51c32aa-2b9cd8c20331edecb8ded48031f994d1"
...
def Market_Trade_SLTP (AccID, CLIENT, Units):
    ...
    if int(Units) > 0:
        ...
        Request_Trade2 = trades.TradeCRCDO(accountID=AccID, tradeID=ID, data= data2)
        CLIENT.request(Request_Trade2)
        ...
        Request_Trade3 = trades.TradeCRCDO(accountID=AccID, tradeID=ID, data=data3)
        CLIENT.request(Request_Trade3)
